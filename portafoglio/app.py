...
def generate_asset_and_weight_inputs(update_clicks, stock_data_json, options_tickers,
    ...
    for asset in asset_names:
        ...
        row_content = html.Div([
            ...
            _chk({'type': 'ir-select-checkbox',     'index': asset}, f'{asset}_InformationRatio', ir_val,     '4%'),
            ...
            _chk({'type': 'dd-select-checkbox',     'index': asset}, f'{asset}_DD',               dd_val,     '8%'),
            _chk({'type': 'vol-select-checkbox',    'index': asset}, f'{asset}_Vol',              vol_val,    '8%'),
            _chk({'type': 'var90-select-checkbox',  'index': asset}, f'{asset}_VaR90',            var90_val,  '8%'),
            _chk({'type': 'var95-select-checkbox',  'index': asset}, f'{asset}_VaR95',            var95_val,  '9%'),
    ...
    for portfolio_num in [1, 2, 3]:
        ...
        portfolio_row = html.Div([
            ...
            html.Div('', style={'width': '8%'}),
            html.Div('', style={'width': '8%'}),
            _pchk({'type': 'ir-select-checkbox',     'index': portfolio_name}, f'{portfolio_name}_InformationRatio', ir_port_val,     '4%'),
            ...
            _pchk({'type': 'dd-select-checkbox',     'index': portfolio_name}, f'{portfolio_name}_DD',               dd_port_val,     '8%'),
            _pchk({'type': 'vol-select-checkbox',    'index': portfolio_name}, f'{portfolio_name}_Vol',              vol_port_val,    '8%'),
            _pchk({'type': 'var90-select-checkbox',  'index': portfolio_name}, f'{portfolio_name}_VaR90',            var90_port_val,  '8%'),
            _pchk({'type': 'var95-select-checkbox',  'index': portfolio_name}, f'{portfolio_name}_VaR95',            var95_port_val,  '9%'),
        ], style={'display': 'flex', 'align-items': 'center', 'border-bottom': '1px dotted #eee',
